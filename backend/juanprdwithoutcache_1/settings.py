"""
Django settings for juanprdwithoutcache_1 project.
...
ROOT_URLCONF = 'juanprdwithoutcache_1.urls'
...
WSGI_APPLICATION = 'juanprdwithoutcache_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "juanprdwithoutcache_1 API",
    "DESCRIPTION": "API documentation for juanprdwithoutcache_1 App",
    "VERSION": "v1",
}
